...
Our first interest is to test the possibility of relying on a cognitive map built from minimal components for exploration and goal-directed navigation.
