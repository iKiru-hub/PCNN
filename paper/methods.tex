...
Additionally, a cost function was introduced over the graph nodes, assigning lower values to BND-modulated cells. This was designed to discourage proximity to the environment’s walls, as shown in plot \ref{fig:model}\textbf{g}.
