...
The activation of each place cell is calculated through a bounded cosine similarity function, determining its corresponding place field (Fig. \ref{fig:model}\textbf{d}).
Further implementation details, including lateral inhibition and recurrent connectivity, are provided in the appendix.
