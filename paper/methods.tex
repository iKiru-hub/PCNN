...
\textbf{a}: \textit{a module of grid cells defined in a bounded square space of length 1, and an activity representation of their receptive field over a torus}
...
Planning was achieved via Dijkstra's algorithm with a cost function that penalized proximity to boundaries, as illustrated in plot \ref{fig:model}\textbf{g}.
