...
Here, neuromodulators are best described by nodes working as preditive analog sensors of external events. Their role is to form synaptic connections with the place cells, effectively determing a scalar field over their representation.
Additionally, they have a way to correct their synaptic weights with subsequent observations, similarly to predictive coding \cite{schultzNeuralSubstratePrediction1997, schultzDopamineRewardPrediction2016, sheynikhovichLongtermMemorySynaptic2023, decothiPredictiveMapsRats2022}.
...
A secondary goal was to enquire about the effect of neuromodulation on the density of place cells, and in particular the reshaping of their place fields following meaningful events, as supported by previous studies \cite{bittnerBehavioralTimeScale2017, milsteinBidirectionalSynapticPlasticity2021, fentonRemappingRevisitedHow2024}.
