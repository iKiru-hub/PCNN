...
% NEUROMODULATORS
Another relevant element in brain dynamics are neuromodulators, endogenous molecules with a range of specialized actions affecting physiology, cognition and behaviour \cite{nadim2014}.
...
Further, projections from the Ventral Tegmental Area (VTA) and Locus Coeruleus (LC) are shown to target hippocampal circuits \cite{fuchsberger2022, edelmann2018}, and affect tuning of CA1 places cells \cite{kempadoo2016, retailleau2014, bittner2017, kaufman2020}, particularly via LEC inputs \cite{igarashi2014, ito2012}.

% COMPUTATIONAL MODELS
Others incorporate reward-driven Hebbian plasticity modulated by neuromodulators \cite{brzosko2019}.
Nonetheless, these architectures mostly fail to unify these ingredients into a biologically grounded system that at the same time learns a map of the environment online without relying on an external coordinate system, and flexibly performs goal-directed navigation.
...
We first aim is to demonstrate that an agent endowed with such bio-inspired model architecture is capable of building content-rich topological maps of the surroundings on the fly, and leveraging it for efficient goal-directed navigation.
...
Further validation was done in multiple experiments in which some aspects of the protocol were varied.
...
However, spatial tuning is achieved through fast synaptic plasticity and competition, and not numerous backpropagation cycles.
The use of solely idiothetic information and not other sensory modalities, such as visual cues, is motivated by reducing architectural complexity and proving the approach validity with minimal sources of information.

% neuromodulation
Concerning neuromodulation, it has been operationalized as a collection of variables acting like low-pass filters of sensory events \cite{ali2021, sheynikhovich2023, bono2023}, here they being solely reward and collision with boundaries.
The action of neuromodulators is forming adaptive connections with the place cells through local Hebbian plasticity, effectively determining a scalar field over the spatial map \cite{sosa2024} that can used for planning \cite{schultz2016, inglis2021, tobler2005, cools2019, decothi2022}.
Moreover, they were also given the opportunity to modulate directly some neuronal properties of place cells, such as the neural activation gain and the place field.

Indeed, another objective of ours was to evaluate how the active neuromodulation of neuronal dynamics may impact task performance.
To this end, multiple comparative ablation experiments were done for highlighting the relevance of each modulatory mechanism.

Finally, we demonstrated how the model dynamically adapts to environmental changes and how some neuromodulatory actions can positively influence the formation and flexibility of a cognitive map \cite{milstein2021, fenton2024}.
