...
In fact, neuromodulation has been long associated with such functionality as well, especially dopamine \cite{kempadooDopamineReleaseLocus2016, schultzDopamineRewardPrediction2016, coolsChemistryAdaptiveMind2019, sheynikhovichLongtermMemorySynaptic2023}.
...
Further, boundary modulation showed to be more impactful in environments with a more internal walls, reasonably because it enehanced their representation in neural space leading to better planning.
Overall, these results aligns with the experimental observations of alteration of place cells upon reward events \cite{bittnerBehavioralTimeScale2017}, in particular in terms of increased cells clustering, reminiscent of rate remapping following contextual shifts \cite{andersonHeterogeneousModulationPlace2003}.
...
The enlargement can then have improved the stability of the representation, marking the nodes more solidly associated with rewards, given the stochasticity of its delivery.
...
Future work can investigate the application to other spatial domains, such as motor control, and include additional neuromodulators encoding for new sensory dimensions.
