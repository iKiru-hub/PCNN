...
In plot \ref{fig:main_results}-\textbf{b} and \ref{fig:results_1}-\textbf{c} we can see the cognitive maps formed in a square environment without and with internal walls, respectively.
